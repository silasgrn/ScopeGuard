...
pub fn run_attack_surface_audit() -> Vec<Finding> {
    ...
    if nodes.is_empty() {
        return vec![Finding {
            ...
            description: "Attack surface modeling is initialized and waiting for discovered nodes.".to_string(),
            risk: "No nodes are yet available for attack surface analysis.".to_string(),
            recommendation: "Add actual discovery of hosts, containers, services, and VPN peers.".to_string(),
